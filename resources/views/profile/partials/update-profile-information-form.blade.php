                    ...
                    <form method="POST" action="{{ route('profile.update') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">{{ __('Laissez vide si vous ne voulez pas changer de mot de passe') }}</small>
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('profile.index') }}" class="btn btn-secondary ml-2">
                                    {{ __('Annuler') }}
                                </a>
                            </div>
                        </div>
