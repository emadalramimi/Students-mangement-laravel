                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="role" class="form-control @error('role') is-invalid @enderror" name="role" required>
                                    <option value="">{{ __('Sélectionnez votre rôle') }}</option>
                                    <option value="eleve" {{ old('role') == 'eleve' ? 'selected' : '' }}>{{ __('Élève') }}</option>
                                    <option value="enseignant" {{ old('role') == 'enseignant' ? 'selected' : '' }}>{{ __('Enseignant') }}</option>
                                </select>
